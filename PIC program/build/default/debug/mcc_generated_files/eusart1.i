...
# 12 "mcc_generated_files/../LCD-library/LCD-library.h"
...
# 13 "mcc_generated_files/../LCD-library/LCD-library.h" 2
...
# 14 "mcc_generated_files/../LCD-library/LCD-library.h" 2
...
# 16 "mcc_generated_files/../LCD-library/LCD-library.h" 2
# 57 "mcc_generated_files/../LCD-library/LCD-library.h"
int LCD_posX = 1,
    LCD_posY = 1,
    LCD_isIncrement = 1,
    LCD_isShift = 0,
...
void HandleInterrupt(void){
    ...
    if (received == '\r' || len == 34){
        if (command[0] == 1){
            ...
            EUSART1_Write(' ');
            char temperature[6];
            sprintf(temperature, "%.2f", 4100.0 / logf(((1024.0 * 10000.0) / ADC_GetConversion(Temperature) - 10000.0) / 0.0111182) - 273.15);
